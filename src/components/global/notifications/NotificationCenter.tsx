    ...
    <div className="relative shrink-0">
      ...
      {open ? (
        <>
          <button
            type="button"
            className="fixed inset-0 z-40 bg-slate-950/10 md:bg-transparent"
            onClick={onToggle}
          ...
          <div
            className={cn(
              "fixed inset-x-3 top-[calc(env(safe-area-inset-top)+72px)] z-50 overflow-hidden rounded-2xl border border-slate-200 bg-white text-right shadow-[0_24px_70px_rgb(15_23_42_/_0.16)] md:absolute md:left-auto md:right-0 md:top-full md:mt-3 md:w-[min(380px,calc(100vw-40px))] lg:left-0 lg:right-auto",
              panelClassName,
            )}
          >
            ...
            <div className="max-h-[min(70vh,32rem)] overflow-y-auto md:max-h-[360px]">
              {loading ? (
                ...
                <div className="grid place-items-center gap-2 px-4 py-8 text-center text-slate-500">
                  ...
                  <p className="m-0 text-size13">لا توجد إشعارات حالياً</p>
                </div>
              ) : (
                notifications.map((notification) => (
                  <div
                    key={notification.id}
                    className={cn(
                      "flex items-start gap-3 border-b border-slate-100 px-3 py-3 last:border-b-0 sm:px-4",
                  ...
                  >
                    ...
                    >
                      ...
                      <div className="min-w-0 flex-1">
                        <div className="flex flex-col gap-1 sm:flex-row sm:items-start sm:justify-between sm:gap-3">
                          <h3 className="m-0 break-words text-size13 font-bold text-slate-800">
                            {notification.title}
                          </h3>
                        ...
                        <p className="m-0 mt-1 break-words text-size12 leading-6 text-slate-600">
                          {notification.message}
                        </p>

                        <div className="mt-2 flex flex-wrap items-center gap-2 text-size11">
                    ...
                    <button
                      ...
                      className="mt-1 inline-flex size-8 shrink-0 items-center justify-center self-start rounded-lg text-slate-400 hover:bg-red-50 hover:text-red-700"
