...
export default function PortalCompanyTrainingForm({
  ...
  const [formData, setFormData] =
    useState<CompanyTrainingFormData>(initialValues);
            ...
            <div className="grid gap-6 md:grid-cols-2 xl:grid-cols-4">
              {isConstrainedMode ? (
                ...
                <CompanyFieldLabel label="التصنيف التدريبي :">
                  <input
                    value={formData.trainingCategory}
                    onChange={(event) =>
                      updateField("trainingCategory", event.target.value)
                    }
                    required
                    className={companyFormInputClassName}
                  />
              ...
              <CompanyFieldLabel label="المسمى التدريبي :">
                <input
                  ...
                  onChange={(event) =>
                    updateField("trainingTitle", event.target.value)
                  }
                  required
                  className={companyFormInputClassName}
                />
              ...
              {isConstrainedMode ? (
                ...
                <CompanyFieldLabel label="مستوى المتدربين :">
                  <input
                    value={formData.traineeLevel}
                    onChange={(event) =>
                      updateField("traineeLevel", event.target.value)
                    }
                    className={companyFormInputClassName}
                  />
                </CompanyFieldLabel>
              ...
              <CompanyFieldLabel label="المدة التدريبية :">
                <input
                  ...
                  onChange={(event) =>
                    updateField("trainingDuration", event.target.value)
                  }
                  required
                  className={companyFormInputClassName}
                />
              ...
              <CompanyFieldLabel label="أيام التدريب :">
                <input
                  ...
                  onChange={(event) =>
                    updateField("trainingSchedule", event.target.value)
                  }
                  required
                  className={companyFormInputClassName}
                />
              ...
              <CompanyFieldLabel label="المكافأة التدريبية :">
                <input
                  ...
                  onChange={(event) =>
                    updateField("trainingReward", event.target.value)
                  }
                  required
                  className={companyFormInputClassName}
                />
              ...
              <CompanyFieldLabel label="مكان التدريب :">
                <input
                  ...
                  onChange={(event) =>
                    updateField("trainingLocation", event.target.value)
                  }
                  required
                  className={companyFormInputClassName}
                />
            ...
            <div className="grid gap-6 lg:grid-cols-2">
              <CompanyFieldLabel label="عن التدريبات :">
                <textarea
                  ...
                  onChange={(event) =>
                    updateField("aboutTraining", event.target.value)
                  }
